    ...
    <footer className="relative bg-[#020408] border-t border-white/[0.04]">
        ...
        <div className="glass-card rounded-2xl p-8 md:p-10 border border-white/[0.08] flex flex-col md:flex-row items-center justify-between gap-6 bg-gradient-to-r from-blue-600/10 via-transparent to-purple-600/10">
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Get insights on software engineering, design, and product development.
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            <p className="text-gray-500 mb-6 max-w-xs text-sm leading-relaxed">
              A software development agency based in Rajshahi, Bangladesh.
              We build scalable web applications, mobile apps, and cloud
              infrastructure for startups and enterprises worldwide.
            </p>
            <div className="space-y-3">
              <a href="mailto:hello@algero.com" className="flex items-center gap-3 text-sm text-gray-500 hover:text-blue-400 transition-colors">
                <Mail className="w-4 h-4" /> hello@algero.com
              </a>
              <a href="tel:+88011714559978" className="flex items-center gap-3 text-sm text-gray-500 hover:text-blue-400 transition-colors">
                <Phone className="w-4 h-4" /> +880 11714559978
              </a>
              <div className="flex items-center gap-3 text-sm text-gray-500">
                <MapPin className="w-4 h-4" /> Rajshahi, Bangladesh
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-white/[0.05] pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-600 gap-4">
          <p>&copy; {new Date().getFullYear()} Algero. All rights reserved.</p>
